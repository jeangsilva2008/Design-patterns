...
public class GumballMachine {
	...
	public void insertQuarter(){
		...
		if(state == HAS_QUARTER){
			...
			System.out.println("Please wait, you´re already giving you a gumball");
		}
	...
	public void ejectQuarter(){
		...
		if(state == HAS_QUARTER){
			...
			System.out.println("You cant eject a quarter, you havent inserted a quarter yet");
		} else if(state == SOLD){
	...
	public void turnCrank(){
		...
		if(state == HAS_QUARTER){
			...
			System.out.println("Turn twice doesnt you another gumball");
		}
	...
	public void dispense() {
		...
		if(state == HAS_QUARTER){
			System.out.println("No gumblle dispensed");
		} else if(state == NO_QUARTER){
